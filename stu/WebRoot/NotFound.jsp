...
<HEAD>
    ...
    BODY {
        SCROLLBAR-FACE-COLOR: #eeeeee; BACKGROUND: url(<%=path %>/404/bg.gif)  repeat-x; SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; SCROLLBAR-SHADOW-COLOR: #dee3e7; SCROLLBAR-3DLIGHT-COLOR: #d1d7dc; SCROLLBAR-ARROW-COLOR: #000000; SCROLLBAR-TRACK-COLOR: #ededed; SCROLLBAR-DARKSHADOW-COLOR: #808080; BACKGROUND-COLOR: #ffffff
    }
    INPUT {
...
<CENTER>
    <DIV id=page>
        ...
        <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
            <TBODY>
                <TR>
                    <TD><IMG src="<%=path %>/404/1.gif" width="17" height="18"></TD>
                    <TD width="100%" background="<%=path %>/404/3.gif"></TD>
                    <TD><IMG src="<%=path %>/404/2.gif" width="17" height="18"></TD>
                </TR>
            </TBODY>
        </TABLE>
        <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
            <TBODY>
                <TR>
                    <TD width=7  background="<%=path %>/404/left.gif"></TD>
                            ...
                            <TBODY>
                                <TR>
                                    <TD align=left width="80%"
                                        height=30>&nbsp;您现在位于：&nbsp;
                                        &nbsp;→&nbsp;
                                        <FONT  color="#ff1e1e" title=出错信息提示>出错信息提示</FONT>
                                    </TD>
                                    <TD align=right width="20%">
                                        <DIV id=div_msg>
                                            <MARQUEE onMouseOver="if (document.all!=null){this.stop()}"
                                                     ...
                                                     scrollAmount=3
                                                     scrollDelay=100>
                                                <IMG src="<%=path %>/404/gao.gif" width="19" height="17">
                                                <FONT  class=red>
                                                   哥还是姐,没有您老人家访问的页面啊!是不是搞错了,要不您再看看,中不?
                                                </FONT>
                                            </MARQUEE>
                                        </DIV>
                                    </TD>
                    ...
                    <TD width=7  background="<%=path %>/404/right.gif"></TD>
                </TR>
            </TBODY>
        </TABLE>
        <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
                        ...
                        <TR>
                            <TD class=bg_1 align=middle height=300>
                                <TABLE cellSpacing=0 cellPadding=0 width=590 border=0>
                                    ...
                                    <TR>
                                        <TD align=right>
                                            <IMG  src="<%=path %>/404/center_error.gif" width="450" height="32" border=0>
                                        </TD>
                                    </TR>
                                    <TR>
                                        <TD align=middle height=380>
                                            <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                                                ...
                                                <TR>
                                                    <TD colSpan=3>
                                                        <IMG height=42 src="<%=path %>/404/error_r1_c1.gif"  width=534 border=0>
                                                    </TD>
                                                    <TD>
                                                        <IMG height=42 src="<%=path %>/404/60du.htm"  width=1 border=0>
                                                    </TD>
                                                </TR>
                                                <TR>
                                                    <TD rowSpan=2>
                                                        <IMG height=239  src="<%=path %>/404/error_r2_c1.gif"  width=43 border=0>
                                                    </TD>
                                                    <TD class=htd align=middle width=479 bgColor=#f7f7f7  height=228>
                                                        <P>
                                                            <FONT  class=red size="5" face="华文新魏">
                                                                您的访问的页面可能被删除或不存在。
                                                            </FONT>
                                                            <BR><BR>
                                                            <BR><BR><BR>
                                                            <A  class=red2 href="#" onclick="JavaScript:history.back()">点击此处可返回</A>
                                                        </P>

                                                    </TD>
                                                    <TD rowSpan=2>
                                                        <IMG height=239 src="<%=path %>/404/error_r2_c3.gif" width=12 border=0>
                                                    </TD>
                                                </TR>
                                                <TR>
                                                    <TD>
                                                        <IMG height=11  src="<%=path %>/404/error_r3_c2.gif"  width=479 border=0>
                                                    </TD>
                                                    <TD>
                                                        <IMG height=11  src="<%=path %>/404/60du.htm" width=1  border=0>
                                                    </TD>
                                                </TR>
                                           </TBODY>
                                        </TABLE>
            ...
            <TR>
                <TD class=bg align=middle width=*>
                    <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                        <TBODY>
                            <TR>
                                <TD><IMG src="<%=path %>/404/4.gif" width="17" height="18"></TD>
                                <TD width="100%"  background="<%=path %>/404/6.gif"></TD>
                                <TD><IMG src="<%=path %>/404/5.gif" width="17" height="18"></TD>
                            </TR>
                        </TBODY>
                    </TABLE>
                    <BR>
